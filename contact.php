                ...
                <div class="p-5 bg-light rounded contact-form">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-7">
                            <form method="POST" action="query/contactUs.php">
                                <input type="text" class="w-100 form-control p-3 mb-4 border-primary bg-light" name="name" placeholder="Your Name">
                                <input type="email" class="w-100 form-control p-3 mb-4 border-primary bg-light" name="email" placeholder="Enter Your Email">
                                <textarea class="w-100 form-control mb-4 p-3 border-primary bg-light" rows="4" name ="emailbody" cols="10" placeholder="Your Message"></textarea>
                        ...
                        <div class="col-md-6 col-lg-5">
                            <div>
                                ...
                                <div class="d-inline-flex w-100 border border-primary p-4 rounded mb-4">
                                    ...
                                    <div class="">
                                        <h4>Mail Us</h4>
                                        <p class="mb-2">PriyaSweetHome@gmail.com</p>
                                        <p class="mb-0">PriyaSweetHomeSupport@gmail.com</p>
                                    </div>
                                </div>
                                <div class="d-inline-flex w-100 border border-primary p-4 rounded">
                                    ...
                                    <div class="">
                                        <h4>Telephone</h4>
                                        <p class="mb-2">+ 94 70 44 53 964</p>
                                        <p class="mb-0">+ 94 71 33 43 564</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                ...
                                <p><i class="fa fa-phone-alt text-primary me-2"></i>+ 94 70 445 3964</p>
                                <p><i class="fa fa-phone-alt text-primary me-2"></i>+ 94 71 334 3564</p>
