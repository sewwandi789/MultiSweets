            ...
            <div class="container">
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <!-- Login Icon -->
                        <button class="btn-search btn btn-primary btn-md-square me-4 rounded-circle d-none d-lg-inline-flex" onclick="window.location.href='LoginPage.php'">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-4 animated bounceInDown">Welcome to Multi Sweets</small>
                        <h1 class="display-1 mb-4 animated bounceInDown"><span class="text-primary">Multi</span>Sweets For Your Dream Event</h1>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <img src="img/kewili.jpg" class="img-fluid rounded animated zoomIn" alt="">
                    </div>
                </div>
            </div>
        </div>
