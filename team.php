            ...
            <div class="container">
                <nav class="navbar navbar-light navbar-expand-lg py-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <button class="btn-search btn btn-primary btn-md-square me-4 rounded-circle d-none d-lg-inline-flex" data-bs-target="#searchModal"><i class="fas fa-user" onclick="window.location.href='LoginPage.php'"></i></button>                      
